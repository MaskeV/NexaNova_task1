// frontend/src/components/MockEvaluation/BatchManagement.jsx
...
const BatchManagement = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const [batchesRes, techRes, studentsRes] = await Promise.all([
    ...
    <div className="batch-management">
      ...
      <div className="filters-section">
        ...
        <button 
          ...
          onClick={() => setFilters({ status: '', technology: '', isActive: '' })}
        >
          Clear Filters
        </button>
      </div>
